    ...
    return (
        <>
            <div className="list-group">
                ...
                <Link to="/tuiter/home"
                      className={`list-group-item ${active === 'home' ? 'active' : ''}`} href="/public/tuiter/HomeScreen/home.html">
                    <div className="row">
                        <div className="col-2">
                ...
                <Link to="/a6/tuiter/explore"
                      className={`list-group-item ${active === 'explore' ? 'active' : ''}`} href="/public/tuiter/ExploreScreen/explore.html">
                    <div className="row">
                        <div className="col-2">
